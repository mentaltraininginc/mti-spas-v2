...
class HTML_facileFormsForm
{
	function edit($option, $tabpane, $pkg, &$row, &$lists, $caller)
	{
		...
		$action = $row->id ? _FACILEFORMS_FORMS_EDIT : _FACILEFORMS_FORMS_ADD;
?>
		...
		function submitbutton(pressbutton)
		{
			...
			if (pressbutton != 'cancel') {
				if (form.title.value == '')
					error += "<?php echo _FACILEFORMS_FORMS_TITLEEMPTY; ?>\n";
				error += checkIdentifier(
					form.name.value,
					"<?php echo _FACILEFORMS_FORMS_NAMEEMPTY; ?>\n",
					"<?php echo _FACILEFORMS_FORMS_NAMEIDENT; ?>\n"
				);
				error += checkNumber(
					form.width.value,
					"<?php echo _FACILEFORMS_FORMS_WIDTHEMPTY; ?>\n",
					"<?php echo _FACILEFORMS_FORMS_WIDTHNUMBER; ?>\n"
				);
				error += checkNumber(
					form.height.value,
					"<?php echo _FACILEFORMS_FORMS_HEIGHTEMPTY; ?>\n",
					"<?php echo _FACILEFORMS_FORMS_HEIGHTNUMBER; ?>\n"
				);
			} // if
			if (error != '')
				alert(error);
		...
		function createInitCode()
		{
			...
			if (name=='') {
				alert("<?php echo _FACILEFORMS_FORMS_ENTNAMEFIRST; ?>");
				return;
			} // if
			if (!confirm("<?php echo _FACILEFORMS_FORMS_CREATEINITNOW; ?>\n<?php echo _FACILEFORMS_FORMS_EXISTINGAPPENDED; ?>")) return;
			code =
			...
			if (oldcode != '')
				form.script1code.value =
					code+
					"\n// -------------- <?php echo _FACILEFORMS_FORMS_OLDCODEBELOW; ?> --------------\n\n"+
					oldcode;
			else
		...
		function createSubmittedCode()
		{
			...
			if (!confirm("<?php echo _FACILEFORMS_FORMS_CREATESUBMITTEDNOW; ?>\n<?php echo _FACILEFORMS_FORMS_EXISTINGAPPENDED; ?>")) return;
			code =
...
?>
		...
		<table cellpadding="4" cellspacing="1" border="0" class="adminform" style="width:780px;">
			<tr><th colspan="3" class="title">Facile Forms - <?php echo $action; ?></th></tr>
			<tr>
				<td></td>
				<td width="100%">
<?php
		...
		$tabs->startTab(_FACILEFORMS_FORMS_SETTINGS,'tab_settings');
?>
			<table class="adminform">
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_TITLE; ?>:</td>
				<td nowrap>
					<input type="text" size="50" maxlength="50" name="title" value="<?php echo $row->title; ?>" class="inputbox"/>
<?php
					echo mosToolTip(_FACILEFORMS_FORMS_TIPTITLE);
?>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_PACKAGE; ?>:</td>
				<td nowrap>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_NAME; ?>:</td>
				<td nowrap>
					<input type="text" size="30" maxlength="30" name="name" value="<?php echo $row->name; ?>" class="inputbox"/>
<?php
					echo mosToolTip(_FACILEFORMS_FORMS_TIPNAME);
?>
				</td>
				<td></td>
			</tr>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_CLASSFOR; ?> &lt;form&gt;:</td>
				<td nowrap>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_ORDERING; ?>:</td>
				<td nowrap><?php echo $lists['ordering']; ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_PUBLISHED; ?>:</td>
				<td nowrap><?php echo mosHTML::yesnoRadioList("published", "", $row->published); ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_RUNMODE; ?>:</td>
				<td nowrap>
					<select name="runmode" size="1" class="inputbox">
						<option value="0"<?php if ($row->runmode==0) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_ANY; ?></option>
						<option value="1"<?php if ($row->runmode==1) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_FRONTEND; ?></option>
						<option value="2"<?php if ($row->runmode==2) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_BACKEND; ?></option>
					</select>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_WIDTH; ?>:</td>
				<td nowrap>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_HEIGHT; ?>:</td>
				<td nowrap>
					<select name="heightmode" size="1" onchange="dispheight(this.value);" class="inputbox">
						<option value="0"<?php if ($row->heightmode==0) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_FIXED; ?></option>
						<option value="1"<?php if ($row->heightmode==1) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_AUTO; ?></option>
						<option value="2"<?php if ($row->heightmode==2) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_AUTOMAX; ?></option>
					</select><span id="heightmargin"<?php if ($row->heightmode==0) echo ' style="display:none;"'; ?>>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo _FACILEFORMS_FORMS_BOTTOMMARGIN; ?>:
			...
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_PREVMODE; ?>:</td>
				<td nowrap>
					<select name="prevmode" size="1" onchange="dispprevwidth();" class="inputbox">
						<option value="0"<?php if ($row->prevmode==0) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_NONE; ?></option>
						<option value="1"<?php if ($row->prevmode==1) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_BELOW; ?></option>
						<option value="2"<?php if ($row->prevmode==2) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_OVERLAYED; ?></option>
					</select>
					<span id="prevwidthvalue"<?php if ($row->widthmode==0 || $row->prevmode==0) echo ' style="display:none;"'; ?>>
						&nbsp;&nbsp;&nbsp;&nbsp;<?php echo _FACILEFORMS_FORMS_WIDTH; ?>: <input size="6" maxlength="6" name="prevwidth" value="<?php echo $row->prevwidth; ?>" class="inputbox" /> px
					</span>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_LOGTODB; ?>:</td>
				<td nowrap>
					<select name="dblog" size="1" class="inputbox">
						<option value="0"<?php if ($row->dblog==0) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_NO; ?></option>
						<option value="1"<?php if ($row->dblog==1) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_NONEMPTY; ?></option>
						<option value="2"<?php if ($row->dblog==2) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_ALLVALS; ?></option>
					</select>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo _FACILEFORMS_FORMS_EMAILNOTIFY; ?>:</td>
				<td>
					<select name="emailntf" size="1" onchange="dispemail(this.value);" class="inputbox">
						<option value="0"<?php if ($row->emailntf==0) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_NO; ?></option>
						<option value="1"<?php if ($row->emailntf==1) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_DEFADDR; ?></option>
						<option value="2"<?php if ($row->emailntf==2) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_CUSTADDR; ?></option>
					</select>
				</td>
				<td></td>
			</tr>
				...
				<td>
					<table cellpadding="0" cellspacing="0" border="0">
						<tr id="emailaddress"<?php if ($row->emailntf!=2) echo ' style="display:none;"'; ?>>
							<td><?php echo _FACILEFORMS_FORMS_EMAIL; ?>:</td>
							<td><input size="50" maxlength="50" name="emailadr" value="<?php echo $row->emailadr; ?>" class="inputbox"/></td>
						</tr>
						<tr id="emaillogging"<?php if ($row->emailntf==0) echo ' style="display:none;"'; ?>>
							<td><?php echo _FACILEFORMS_FORMS_REPORT; ?>:</td>
							<td>
								<select name="emaillog" size="1" class="inputbox">
									<option value="0"<?php if ($row->emaillog==0) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_HDRONLY; ?></option>
									<option value="1"<?php if ($row->emaillog==1) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_NONEMPTY; ?></option>
									<option value="2"<?php if ($row->emaillog==2) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_ALLVALS; ?></option>
								</select>
							</td>
						</tr>
						<tr id="emailattachment"<?php if ($row->emailntf==0) echo ' style="display:none;"'; ?>>
							<td><?php echo _FACILEFORMS_FORMS_EMAILXML; ?>: </td>
							<td>
								<select name="emailxml" size="1" class="inputbox">
									<option value="0"<?php if ($row->emailxml==0) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_NO; ?></option>
									<option value="1"<?php if ($row->emailxml==1) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_NONEMPTY; ?></option>
									<option value="2"<?php if ($row->emailxml==2) echo ' selected="selected"'; ?>><?php echo _FACILEFORMS_FORMS_ALLVALS; ?></option>
								</select>
							</td>
						</tr>
					</table>
			...
			<tr>
				<td></td>
				<td colspan="2">
					<?php echo _FACILEFORMS_FORMS_DESCRIPTION; ?>:
...
<?php
		$tabs->endTab();
		$tabs->startTab(_FACILEFORMS_FORMS_SCRIPTS,'tab_scripts');
...
?>
			...
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo _FACILEFORMS_FORMS_INITSCRIPT; ?></legend>
						<table cellpadding="4" cellspacing="1" border="0">
							<tr>
								<td nowrap><?php echo _FACILEFORMS_FORMS_TYPE; ?>:</td>
								<td nowrap>
									<input type="radio" id="script1cond1" name="script1cond" value="0" onclick="dispinit(this.value)"<?php if ($row->script1cond==0) echo ' checked="checked"'; ?> /><label for="script1cond1"> <?php echo _FACILEFORMS_FORMS_NONE; ?></label>
									<input type="radio" id="script1cond2" name="script1cond" value="1" onclick="dispinit(this.value)"<?php if ($row->script1cond==1) echo ' checked="checked"'; ?> /><label for="script1cond2"> <?php echo _FACILEFORMS_FORMS_LIBRARY; ?></label>
									<input type="radio" id="script1cond3" name="script1cond" value="2" onclick="dispinit(this.value)"<?php if ($row->script1cond==2) echo ' checked="checked"'; ?> /><label for="script1cond3"> <?php echo _FACILEFORMS_FORMS_CUSTOM; ?></label>
								</td>
								<td></td>
							</tr>
							<tr id="initlib" style="display:none;">
								<td nowrap><?php echo _FACILEFORMS_FORMS_SCRIPT; ?>:</td>
								<td nowrap>
...
?>
							...
							<tr id="initcode" style="display:none;">
								<td nowrap valign="top" colspan="2">
									...
									<a href="#" onClick="createInitCode();"><?php echo _FACILEFORMS_FORMS_CREATEFRAME; ?></a>
<?php
									echo mosToolTip(_FACILEFORMS_FORMS_TIPINITCODE);
?>
									<br />
			...
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo _FACILEFORMS_FORMS_SUBMITTEDSCRIPT; ?></legend>
						<table cellpadding="4" cellspacing="1" border="0">
							<tr>
								<td nowrap><?php echo _FACILEFORMS_FORMS_TYPE; ?>:</td>
								<td nowrap>
									<input type="radio" id="script2cond1" name="script2cond" value="0" onclick="dispsubmitted(this.value)"<?php if ($row->script2cond==0) echo ' checked="checked"'; ?> /><label for="script2cond1"> <?php echo _FACILEFORMS_FORMS_NONE; ?></label>
									<input type="radio" id="script2cond2" name="script2cond" value="1" onclick="dispsubmitted(this.value)"<?php if ($row->script2cond==1) echo ' checked="checked"'; ?> /><label for="script2cond2"> <?php echo _FACILEFORMS_FORMS_LIBRARY; ?></label>
									<input type="radio" id="script2cond3" name="script2cond" value="2" onclick="dispsubmitted(this.value)"<?php if ($row->script2cond==2) echo ' checked="checked"'; ?> /><label for="script2cond3"> <?php echo _FACILEFORMS_FORMS_CUSTOM; ?></label>
								</td>
								<td></td>
							</tr>
...
?>
							...
							<tr id="submittedcode" style="display:none;">
								<td nowrap valign="top" colspan="2">
									...
									<a href="#" onClick="createSubmittedCode();"><?php echo _FACILEFORMS_FORMS_CREATEFRAME; ?></a>
<?php
									echo mosToolTip(_FACILEFORMS_FORMS_TIPSUBMITTEDCODE);
?>
									<br />
...
<?php
		$tabs->endTab();
		$tabs->startTab(_FACILEFORMS_FORMS_FORMPIECES,'tab_formpieces');
...
?>
			...
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo _FACILEFORMS_FORMS_BEFOREFORM; ?></legend>
						<table cellpadding="4" cellspacing="1" border="0">
							<tr>
								<td nowrap><?php echo _FACILEFORMS_FORMS_TYPE; ?>:</td>
								<td nowrap>
									<input type="radio" id="piece1cond0" name="piece1cond" value="0" onclick="dispp1(this.value)"<?php if ($row->piece1cond==0) echo ' checked="checked"'; ?> /><label for="piece1cond0"> <?php echo _FACILEFORMS_FORMS_NONE; ?></label>
									<input type="radio" id="piece1cond1" name="piece1cond" value="1" onclick="dispp1(this.value)"<?php if ($row->piece1cond==1) echo ' checked="checked"'; ?> /><label for="piece1cond1"> <?php echo _FACILEFORMS_FORMS_LIBRARY; ?></label>
									<input type="radio" id="piece1cond2" name="piece1cond" value="2" onclick="dispp1(this.value)"<?php if ($row->piece1cond==2) echo ' checked="checked"'; ?> /><label for="piece1cond2"> <?php echo _FACILEFORMS_FORMS_CUSTOM; ?></label>
								</td>
								<td></td>
							</tr>
							<tr id="p1lib" style="display:none;">
								<td nowrap><?php echo _FACILEFORMS_FORMS_PIECE; ?>:</td>
								<td nowrap>
...
?>
			...
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo _FACILEFORMS_FORMS_AFTERFORM; ?></legend>
						<table cellpadding="4" cellspacing="1" border="0">
							<tr>
								<td nowrap><?php echo _FACILEFORMS_FORMS_TYPE; ?>:</td>
								<td nowrap>
									<input type="radio" id="piece2cond0" name="piece2cond" value="0" onclick="dispp2(this.value)"<?php if ($row->piece2cond==0) echo ' checked="checked"'; ?> /><label for="piece2cond0"> <?php echo _FACILEFORMS_FORMS_NONE; ?></label>
									<input type="radio" id="piece2cond1" name="piece2cond" value="1" onclick="dispp2(this.value)"<?php if ($row->piece2cond==1) echo ' checked="checked"'; ?> /><label for="piece2cond1"> <?php echo _FACILEFORMS_FORMS_LIBRARY; ?></label>
									<input type="radio" id="piece2cond2" name="piece2cond" value="2" onclick="dispp2(this.value)"<?php if ($row->piece2cond==2) echo ' checked="checked"'; ?> /><label for="piece2cond2"> <?php echo _FACILEFORMS_FORMS_CUSTOM; ?></label>
								</td>
								<td></td>
							</tr>
...
<?php
		$tabs->endTab();
		$tabs->startTab(_FACILEFORMS_FORMS_SUBMPIECES,'tab_submpieces');
...
?>
			...
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo _FACILEFORMS_FORMS_BEGINSUBMIT; ?></legend>
						<table cellpadding="4" cellspacing="1" border="0">
							<tr>
								<td nowrap><?php echo _FACILEFORMS_FORMS_TYPE; ?>:</td>
								<td nowrap>
									<input type="radio" id="piece3cond0" name="piece3cond" value="0" onclick="dispp3(this.value)"<?php if ($row->piece3cond==0) echo ' checked="checked"'; ?> /><label for="piece3cond0"> <?php echo _FACILEFORMS_FORMS_NONE; ?></label>
									<input type="radio" id="piece3cond1" name="piece3cond" value="1" onclick="dispp3(this.value)"<?php if ($row->piece3cond==1) echo ' checked="checked"'; ?> /><label for="piece3cond1"> <?php echo _FACILEFORMS_FORMS_LIBRARY; ?></label>
									<input type="radio" id="piece3cond2" name="piece3cond" value="2" onclick="dispp3(this.value)"<?php if ($row->piece3cond==2) echo ' checked="checked"'; ?> /><label for="piece3cond2"> <?php echo _FACILEFORMS_FORMS_CUSTOM; ?></label>
								</td>
								<td></td>
							</tr>
...
?>
			...
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo _FACILEFORMS_FORMS_ENDSUBMIT; ?></legend>
						<table cellpadding="4" cellspacing="1" border="0">
							<tr>
								<td nowrap><?php echo _FACILEFORMS_FORMS_TYPE; ?>:</td>
								<td nowrap>
									<input type="radio" id="piece4cond0" name="piece4cond" value="0" onclick="dispp4(this.value)"<?php if ($row->piece4cond==0) echo ' checked="checked"'; ?> /><label for="piece4cond0"> <?php echo _FACILEFORMS_FORMS_NONE; ?></label>
									<input type="radio" id="piece4cond1" name="piece4cond" value="1" onclick="dispp4(this.value)"<?php if ($row->piece4cond==1) echo ' checked="checked"'; ?> /><label for="piece4cond1"> <?php echo _FACILEFORMS_FORMS_LIBRARY; ?></label>
									<input type="radio" id="piece4cond2" name="piece4cond" value="2" onclick="dispp4(this.value)"<?php if ($row->piece4cond==2) echo ' checked="checked"'; ?> /><label for="piece4cond2"> <?php echo _FACILEFORMS_FORMS_CUSTOM; ?></label>
								</td>
								<td></td>
							</tr>
		...
		<script type="text/javascript">
			...
			function submitbutton(pressbutton)
			{
				...
				switch (pressbutton) {
					...
					case 'remove':
						if (form.boxchecked.value==0) {
							alert("<?php echo _FACILEFORMS_FORMS_SELFORMSFIRST; ?>");
							return;
						} // if
						break;
					default:
				...
				if (pressbutton == 'remove')
					if (!confirm("<?php echo _FACILEFORMS_FORMS_ASKDEL; ?>")) return;
			...
			<tr>
				<td width="50%" nowrap>
					<table class="adminheading">
						<tr><th nowrap class="edit">Facile Forms <?php echo $ff_version; ?><br/><span class="componentheading"><?php echo _FACILEFORMS_FORMS_MANAGEFORMS; ?></span></th></tr>
					</table>
				</td>
				<td nowrap>
					<?php echo _FACILEFORMS_FORMS_PACKAGE; ?>:
...
?>
		...
		<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
			<tr>
				...
				<th nowrap align="left"><?php echo _FACILEFORMS_FORMS_TITLE; ?></th>
				<th nowrap align="left"><?php echo _FACILEFORMS_FORMS_NAME; ?></th>
				<th nowrap align="left"><?php echo _FACILEFORMS_FORMS_PAGES; ?></th>
				<th nowrap align="right"><?php echo _FACILEFORMS_FORMS_WIDTH; ?></th>
				<th nowrap align="right"><?php echo _FACILEFORMS_FORMS_HEIGHT; ?></th>
				<th nowrap align="right"><?php echo _FACILEFORMS_FORMS_SCRIPTID; ?></th>
				<th nowrap align="center"><?php echo _FACILEFORMS_FORMS_PUBLISHED; ?></th>
				<th nowrap align="center" colspan="2"><?php echo _FACILEFORMS_FORMS_REORDER; ?></th>
				<th align="left"><?php echo _FACILEFORMS_FORMS_DESCRIPTION; ?></th>
			</tr>
<?php
			$k = 0;
...
?>
				<tr class="row<?php echo $k; ?>">
					...
					switch ($row->heightmode) {
						case 1:
							$text = _FACILEFORMS_FORMS_AUTO;
							if ($row->height > 0) $text .= '+'.$row->height.'px';
							break;
						case 2:
							$text = _FACILEFORMS_FORMS_AUTOMAX;
							if ($row->height > 0) $text .= '+'.$row->height.'px';
							break;
						default:
							$text = $row->height.'px';

...
function com_install() {
  ...
  <table width="100%" border="0">
    <tr>
      <td>&nbsp;</td>
      <td>
        <strong>samSiteMap - A Joomla!/Mambo Site Map and Indexing Component</strong><br/>
        <font class="small">&copy; Copyright 2005 Steve Graham, SAM Code Team<br/>
        This component is released under the terms of the GNU GPL.</font><br/>
      </td>
    </tr>
    <tr>

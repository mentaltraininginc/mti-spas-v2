...
/**
*
* @version $Id: english.php,v 1.12 2005/11/18 16:43:50 soeren_nb Exp $
* @package VirtueMart
...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_CHECKOUT_TITLE_A = 'Checkout';
	var $_PHPSHOP_CHECKOUT_TITLE_B = 'Credit Card';
	...
	var $_PHPSHOP_ACCOUNT_TITLE = 'My Account Details';
	...
	var $_PHPSHOP_USER_FORM_BILLTO_LBL = 'Address Information';
	...
	var $_PHPSHOP_EMPTY_CART = 'Your Cart is empty.';
	...
	var $_PHPSHOP_ORDER_ITEM = 'Items In The Order';
	var $_PHPSHOP_ORDER_PRINT_PO_LBL = 'Order Details';
	...
	var $_PHPSHOP_ORDER_PRINT_CUST_INFO_LBL = 'Login Information';
	...
	var $_PHPSHOP_CHECKOUT_CONF_CONFIDENT = 'You can be confident that your credit card details are safe and secure with <strong>RobertNeff.com</strong>. Every transaction uses 128-bit SSL encryption secured by Geo<strong>Trust</strong>&reg; and powered by i<strong>Transact</strong>&reg;.';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO = 'Payment Information';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_NAMECARD = 'Cardholder\'s Name';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_METHOD = 'Payment Method';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_CCNUM = 'Card #';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_EXDATE = 'Exp. Date';
	...
	var $_PHPSHOP_NEW_CUSTOMER = 'New to RobertNeff.com? &nbsp; Create your new RobertNeff.com acount below to continue.';
	var $_PHPSHOP_ACC_CUSTOMER_ACCOUNT = 'Customer Name:';
	var $_PHPSHOP_ACC_CUSTOMER_HEADER = 'My Account Details';
	var $_PHPSHOP_ACC_ORDER_INFO = 'Order History';
	...
	var $_PHPSHOP_ACC_ACCOUNT_INFO = 'Modify Account Information';
	var $_PHPSHOP_ACC_ACCOUNT_LOGIN_INFO = 'Modify Login Information (optional)';
	...
	var $_PHPSHOP_CHECKOUT_MSG_4 = 'Payment Details';
	...
	var $_PHPSHOP_CHECKOUT_CUSTOMER_NOTE = 'To leave us a note about your order, click here.';
	...
	var $_PHPSHOP_DOWNLOADS_INFO = 'To download your eBook, click the <strong>\'Start Download\'</strong> button below.<br /><br /><i>Please Note:</i>  To download the eBook you purchased, log in to your RobertNeff.com account, and click \'My Account Details\'.  There you will find a list of every order you have placed with RobertNeff.com.  You will find download links in the Order Details page.<br /><br />';
	...
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_3 = 'You may download an eBook a maximum of  ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_4 = 'Downloads will automatically expire {expire} days after the first download attempt.';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_5 = 'Questions? Problems?';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_6 = 'Download-Info by ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_7 = 'For your information, the following download links can always be found online in your RobertNeff.com account under "My Account Details.';
	...
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER1A = 'Thank you for shopping with us.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER1B = '<strong>CLICK HERE</strong> to download the eBook(s) you purchased and to view the following order information in your secure online RobertNeff.com Account:';
	...
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER5 = 'Download eBooks and view the order online by following this link.';
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).';
	...
	var $_PHPSHOP_UPDATE_ADDRESS = '<strong>Click Here</strong> to Change Billing Address';
	var $_PHPSHOP_CONTINUE_SHOPPING = 'Continue Shopping';
	var $_PHPSHOP_THANKYOU_SUCCESS = 'Your order has been successfully placed!';
	var $_PHPSHOP_ORDER_LINK = 'To download your eBook, and to view the Order Details, follow this link.';
...
';
    ...
    ################## JBRIDGE START ###########
	var $_PHPSHOP_CART_PARAM_RECUR = 'Item must be purchased seperately from items in your cart.';
	var $_PHPSHOP_CART_PARAM_QUANTITY_EXCEEDED = 'Exceeded maximum quantity for this item. Quantity has been adjusted to maximum.';
	var $_PHPSHOP_CART_PARAM_REQUIRED_SKU = 'Item cannot be purchased. Required products are not in your cart or previously purchased.';      
	var $_PHPSHOP_CART_PARAM_BLOCKED_SKU = 'Products in your cart or previously purchased may not be purchased with this product.';
    ################## JBRIDGE END ###########
}

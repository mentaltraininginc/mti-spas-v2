  ...
  ***************************************************************************/    
  function get_affiliate_details($user_id,$affiliate_id='0')
  {
   global $auth;
	...
	/****************************************************
	 * Modified by Erik Neff to correct problem with	*
	 * invalid table column access attempt on			*
	 * jos_users.user_info_id.							*
	 * Corrected: #__users -> #__{vm}_user_info			*
	 * This section: gets the affiliate id from			*
	 * the affiliate table for this user				*
	 ****************************************************/
	$q =  "SELECT * FROM #__{vm}_affiliate, #__{vm}_user_info";
	...
	/****************************************************
	 * End of Modification by Erik Neff					*
	 ****************************************************/
	$db->query($q);
    if($db->next_record()){

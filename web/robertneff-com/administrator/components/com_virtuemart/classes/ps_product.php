	...
	function show_price( $product_id, $hide_tax = false ) {
		...
		if( $auth['show_prices'] ) {
			...
			if (isset($price_info["product_price_id"])) {
				...
				/********************************************
				 * If-Else added by Erik Neff to address	*
				 * The appearance of Discounted Items		*
				 *******************************************/
				
				if(!empty($discount_info["amount"])) {
					$html .= "<span style=\"color:red;\">\n<strike>" ;
					$html .= "Regular Price: " . $CURRENCY_DISPLAY->getFullValue($undiscounted_price);
					$html .= "</strike> $text_including_tax</span>\n<br/>";
					
					$html .= "<span style=\"font-weight:bold\">\n";
					$html .= "Sale Price: " . $CURRENCY_DISPLAY->getFullValue($base_price);
					$html .= "</span>\n ";
				}
				else {
					$html .= "<span style=\"font-weight:bold\">\n";
					$html .= "Price: " . $CURRENCY_DISPLAY->getFullValue($base_price);
					$html .= "</span>\n ";
				}

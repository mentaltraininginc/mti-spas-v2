...
if ($cc_payments==true) {
	...
	<div style="float:left; width:54%">
		<fieldset style="height:210px"><legend><strong><?php echo $VM_LANG->_PHPSHOP_CHECKOUT_PAYMENT_CC ?></strong></legend>
				<table border="0" style="padding-left:2px; vertical-align:top" "cellspacing="0" cellpadding="0" align="left">
					<tr>
						<td colspan="2">
							<?php $ps_payment_method->list_cc($payment_method_id, false) ?>
							<img src="<?php echo $mosconfig_live_site . "media/mc_vs_ax.png";?>"/>
						</td>
					</tr>
					<tr>
						<td nowrap width="10%" align="left">Card Type:</td>
						<td>
				...
				<?php } ?>
					<tr>
						<td nowrap width="10%" align="left"><?php echo $VM_LANG->_PHPSHOP_CHECKOUT_CONF_PAYINFO_EXDATE ?>:</td>
						<td><?php 
	...
	<div style="float:left; width:44%">
		<fieldset style="height:210px"><legend><strong><?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_CUST_BILLING_LBL ?></strong></legend>
		<?php $boo = "urns";

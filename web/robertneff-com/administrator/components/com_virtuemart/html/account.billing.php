...
$shopper_fields[uniqid('fieldset_begin')] = $VM_LANG->_PHPSHOP_ACC_ACCOUNT_LOGIN_INFO;
...
<div style="float:left; width:20%; text-align:left;">
	  <a href = "javascript:history.back()" style="color:#000000">
	    <strong>
		  Go Back
		</strong>
	  </a>
...
<div style="float:left;width:70%;text-align:right;"> 
    <span>
		<strong>
    	<input type="image" name="submit" alt="<?php echo _E_SAVE ?>"  onclick="return( submitshopperform());" />
		</strong>
    </span>
</div>
<div style="width:90%;">

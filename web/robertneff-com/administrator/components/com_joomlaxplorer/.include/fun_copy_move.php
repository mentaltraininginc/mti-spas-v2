...
//-->
		...
		echo "<img src=\""._QUIXPLORER_URL."/_img/__paste.png\" align=\"ABSMIDDLE\" ALT=\"\">\n";
		...
		for($i=0;$i<$cnt;++$i) {
			...
			echo "<tr><td><img src=\""._QUIXPLORER_URL."/_img/_info.png\" align=\"absmiddle\" alt=\"\">";
			// old name

  ...
  /**
	...
	*/
	function getUser() {
		...
		/* Hack for integration with JACLPlus Component */
		$user->jaclplus		= $this->_session->jaclplus;
		/* End of hack for JACLPlus Component */
...
function mosMenuCheck( $Itemid, $menu_option, $task, $gid ) {
	...
	foreach ($results as $result) {
		...
		if( !jaclplusInList( $result->access, $my->jaclplus ) ) {
			return false;
		}
	}
	//return ($access <= $gid);
...
/* Hack for integration with JACLPlus Component */
function jaclplusInList ( $value, $list ) {

...
*
* @version $Id: mod_virtuemart.php,v 1.4 2005/11/09 21:07:50 soeren_nb Exp $
* @package VirtueMart
* @subpackage modules
* 
...
//make module show customized title with user name in it
if ($auth["username"]=="demo") echo "<h3>Welcome Guest!</h3>";
else echo "<h3>Welcome ".$auth["first_name"]."!</h3>";
...
if ($perm->check("admin,storeadmin") 
  ...
  ?> 
    ...
    <tr>
		<td colspan="2">
	      <div style="position:absolute; top:inherit; left:inherit">
		   <div style="position:relative; left:4px">
			<a href="<?php $sess->purl(SECUREURL . "index.php?page=account.index");?>">
				<img src="<?php echo $mosconfig_live_site ;?>media/my_account_details.gif" border="0" />
			</a>
		   </div>
		  </div>
		  <div style="position:relative; top:inherit; left:34px; top:5px">
			<a href="<?php $sess->purl(SECUREURL . "index.php?page=account.index");?>">
				<?php echo $VM_LANG->_PHPSHOP_ACCOUNT_TITLE ?></a>
			</a>
		  </div><br />
		</td>
    </tr>
...
?>
    <tr>
		<td colspan="2">
	      <div style="position:absolute; top:inherit; left:inherit">
			<a class="<?php echo $class_mainlevel ?>" href="<?php $sess->purl($mm_action_url."index.php?page=shop.cart")?>"><img src="<?php echo $mosconfig_live_site . "media/shopping_cart_log_v2.jpg";?>" border="0" /></a>
		  </div>
		  <div style="position:relative; top:inherit; left:30px; top:5px">
			<a class="<?php echo $class_mainlevel ?>" href="<?php $sess->purl($mm_action_url."index.php?page=shop.cart")?>"><?php echo $VM_LANG->_PHPSHOP_CART_SHOW ?>
			</a>
		  </div><br />
		</td>
    </tr>
